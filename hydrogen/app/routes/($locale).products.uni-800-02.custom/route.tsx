...
import { CustomOrderPreview_uni80002 } from "~/routes/($locale).products.uni-800-02.custom/components/custom-order-preview"
...
import { CustomOrderOption_uni80002 } from "~/lib/custom-order/options/uni-800-02"
...
export default function Route() {
  ...
  const option = new CustomOrderOption_uni80002(state)
...
export async function loader(props: LoaderFunctionArgs) {
  const handle = "uni-800-02-custom"
