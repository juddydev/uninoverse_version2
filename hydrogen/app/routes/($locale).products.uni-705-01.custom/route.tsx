...
import { CustomOrderPreview_uni70501 } from "~/routes/($locale).products.uni-705-01.custom/components/custom-order-preview"
...
import { CustomOrderOption_uni70501 } from "~/lib/custom-order/options/uni-705-01"
...
export default function Route() {
  ...
  const option = new CustomOrderOption_uni70501(state)
...
export async function loader(props: LoaderFunctionArgs) {
  const handle = "uni-705-01-custom"
