...
import { CustomOrderTexture_uni71101 } from "~/lib/custom-order/textures/uni-711-01"
...
export function CustomOrderPreview_uni71101(props: Props) {
  const { viewport } = useThree()

  const { nodes } = useGLTF(props.modelSource.url)

  const texture = new CustomOrderTexture_uni71101(props.state)
