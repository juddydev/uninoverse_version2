...
import { CustomOrderPreview_uni70701 } from "~/routes/($locale).products.uni-707-01.custom/components/custom-order-preview"
...
import { CustomOrderOption_uni70701 } from "~/lib/custom-order/options/uni-707-01"
...
export default function Route() {
  ...
  const option = new CustomOrderOption_uni70701(state)
...
export async function loader(props: LoaderFunctionArgs) {
  const handle = "uni-707-01-custom"
