...
import { CustomOrderPreview_uni70301 } from "~/routes/($locale).products.uni-703-02.custom/components/custom-order-preview"
...
import { CustomOrderOption_uni70302 } from "~/lib/custom-order/options/uni-703-02"
...
export default function Route() {
  ...
  const option = new CustomOrderOption_uni70302(state)
...
export async function loader(props: LoaderFunctionArgs) {
  const handle = "uni-703-02-custom"
