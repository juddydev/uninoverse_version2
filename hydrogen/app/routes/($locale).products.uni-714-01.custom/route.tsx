...
import { CustomOrderPreview_uni71401 } from "~/routes/($locale).products.uni-714-01.custom/components/custom-order-preview"
...
import { CustomOrderOption_uni71401 } from "~/lib/custom-order/options/uni-714-01"
...
export default function Route() {
  ...
  const [state, dispatch] = useReducer(customOrderReducer, {
    ...
    liningType: customOrderLiningType.deerSkin,
  ...
  const option = new CustomOrderOption_uni71401(state)
...
export async function loader(props: LoaderFunctionArgs) {
  const handle = "uni-714-01-custom"
