...
import { CustomOrderPreview_uni70601 } from "~/routes/($locale).products.uni-706-01.custom/components/custom-order-preview"
...
import { CustomOrderOption_uni70601 } from "~/lib/custom-order/options/uni-706-01"
...
export default function Route() {
  ...
  const option = new CustomOrderOption_uni70601(state)
...
export async function loader(props: LoaderFunctionArgs) {
  const handle = "uni-706-01-custom"
