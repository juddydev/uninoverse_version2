...
import { CustomOrderPreview_uni70001 } from "~/routes/($locale).products.uni-700-01.custom/components/custom-order-preview"
...
import { CustomOrderOption_uni70001 } from "~/lib/custom-order/options/uni-700-01"
...
export default function Route() {
  ...
  const config = new CustomOrderOption_uni70001(state)
...
export async function loader(props: LoaderFunctionArgs) {
  const handle = "uni-700-01-custom"
