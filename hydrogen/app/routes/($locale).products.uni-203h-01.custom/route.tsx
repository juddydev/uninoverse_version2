...
import { CustomOrderPreview_uni203h01 } from "~/routes/($locale).products.uni-203h-01.custom/components/custom-order-preview"
...
import { CustomOrderOption_uni203h01 } from "~/lib/custom-order/options/uni-203h-01"
...
export default function Route() {
  ...
  const option = new CustomOrderOption_uni203h01(state)
...
export async function loader(props: LoaderFunctionArgs) {
  const handle = "uni-203h-01-custom"
