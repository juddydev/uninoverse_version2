...
import { CustomOrderPreview_uni71001 } from "~/routes/($locale).products.uni-710-01.custom/components/custom-order-preview"
...
import { CustomOrderOption_uni71001 } from "~/lib/custom-order/options/uni-710-01"
...
export default function Route() {
  ...
  const option = new CustomOrderOption_uni71001(state)
...
export async function loader(props: LoaderFunctionArgs) {
  const handle = "uni-710-01-custom"
