...
import { CustomOrderPreview_uni71201 } from "~/routes/($locale).products.uni-712-01.custom/components/custom-order-preview"
...
import { CustomOrderOption_uni71201 } from "~/lib/custom-order/options/uni-712-01"
...
export default function Route() {
  ...
  const option = new CustomOrderOption_uni71201(state)
...
export async function loader(props: LoaderFunctionArgs) {
  const handle = "uni-712-01-custom"
